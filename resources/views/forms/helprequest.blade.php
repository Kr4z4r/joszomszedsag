        ...
        <div class="row">
            <div class="col s12">
                <form method="post" action="{{url('form-submit')}}"  id="helprequest_reg_form" class="card-panel hoverable" autocomplete="{{ Str::random(16) }}">
                    <div class="row">
                        <h4>{{ __('forms.help_request_form_title') }}</h4>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s12 m4">
                            ...
                            <span class="helper-text" data-error="{{ __('forms.phone_helper_text') }}"></span>
                        </div>
                    ...
                    <div class="row">
                        <div class="input-field col s12 m6 l6">
                            <select id="help_types" name="help_types">
                                <option value="" disabled @if(old('help_types') == null) selected @endif>{{ __('forms.please_choose') }}</option>

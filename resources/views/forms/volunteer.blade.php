        ...
        <div class="row">
            <div class="col s12">
                <form method="post" action="{{url('form-submit')}}" id="volunteer_reg_form" class="card-panel hoverable" autocomplete="{{ Str::random(16) }}">
                    <div class="row">
                        <h4 class="center-align">{{ __('Önkéntes jelentkezés Vigyázónak') }}</h4>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col s12 m4">
                            <div class="input-field col s12">
                                ...
                                <label for="availability">{{ __('Rendelkezésre állás:') }}</label>
                            </div>
                        </div>
                        <div class="col s12 m4">
                            <div class="input-field col s12">
                                <select multiple id="help_types" name="help_types[]" data-old_value="{{ old('help_types.0') }}">
                                    <option value="0" disabled selected>{{ __('Kérem válasszon') }}</option>
                            ...
                            @for($i=1; $i<=count(old('area_street')); $i++)
                                <div class="area-input-group row">
                                    ...
                                    <div class="input-field col s6 m2">
                                        ...
                                        <label for="area_from-house-number_{{$i}}">{{ __('Házszám(-tól)') }}</label>
                                        <span class="helper-text">{{ __('Hagyja üresen, ha az egész utcát vállalja.') }}</span>
                                    </div>
                                    <div class="input-field col s6 m2">
                                        ...
                                        <label for="area_to-house-number_{{$i}}">{{ __('Házszám(-ig)') }}</label>
                                        <span class="helper-text">{{ __('Hagyja üresen, ha az egész utcát vállalja.') }}</span>
                                    </div>
